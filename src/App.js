      ...
      <div className="grid-bottom-in">
        ...
        <div className="grid-bottom-in-in">
          <div className="grid-bottom-in-node-text">
            <h2>PYTHON</h2>
            <div className="nomal-text">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;มีประสบการณ์เกี่ยวกับ PYTHON ในด้าน
              Data Science เรื่องภาพและเสียง <br />
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;มีประสบการ์ในการใช้ Database ชนิด
        ...
        <div className="grid-bottom-in-in">
          ...
          <div className="grid-bottom-in-node-text">
            ...
            <div className="nomal-text">
              ...
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;มีประสบการ์ในการใช้ 3DMAX ในการแก้ไข
              model และฉากของเกม <br />
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;มีประสบการณ์
        ...
        <div className="grid-bottom-in-in">
          <div className="grid-bottom-in-node-text">
            ...
            <div className="nomal-text">
              ...
              <br />
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;มีประสบการณ์ในการใช้ K8S เพื่อสร้าง
              pod โดยรับคำสั่งจาก GitLab Runner
            </div>
          </div>
